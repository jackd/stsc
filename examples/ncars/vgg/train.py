...
callbacks = []
# lr = base_lr
# callbacks = [keras.callbacks.ReduceLROnPlateau(monitor="loss", patience=5, factor=0.1)]
...
if backend == "jax":
    ...
    # jax_preprocessor = lambda *args: preprocessor(args)  # HACK
